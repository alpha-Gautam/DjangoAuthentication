...
from account.views import RegistrationView, ActivateView, TestAPI, LoginView, DeleteUserView, LogoutView, GetCSRFToken,UserDetailsView, UpdatePasswordView, ForgotPasswordView, ResetPasswordPageView
...
urlpatterns = [
    ...
    path('account/reset_password/<str:uid>/<str:token>/', ResetPasswordPageView.as_view(), name='reset_password'),
